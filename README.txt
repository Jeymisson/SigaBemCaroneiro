...
2) COMO EXECUTAR:
 ...
 - 2.2) Entrar na pasta raiz do projeto pelo terminal e digitar o seguinte comando mvn install:install-file -Dfile=easyaccept.jar -DgroupId=ufcg.edu.br -DartifactId=easyaccept -Dversion=1.0.0 -Dpackaging=jar -DgeneratePom=true 
 - 2.3) Executar pelo Maven o projeto.

3) Ferramentas úteis para o projeto:
  - Maven.
  - Git.
