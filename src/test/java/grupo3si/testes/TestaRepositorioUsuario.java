...
public class TestaRepositorioUsuario {
	...
	public void TestaGetCarona() {
		...
		String idCarona1 = user1.getPerfil().getHistoricoDeCaronas().get(0)
				.getId()
				+ "";
		String idCarona2 = user1.getPerfil().getHistoricoDeCaronas().get(1)
				.getId()
				+ "";
		String idCarona3 = user1.getPerfil().getHistoricoDeCaronas().get(2)
				.getId()
				+ "";
		String idCarona4 = user1.getPerfil().getHistoricoDeCaronas().get(3)
				.getId()
				+ "";
		String idCarona5 = user1.getPerfil().getHistoricoDeCaronas().get(4)
				.getId()
				+ "";
		String idCarona6 = user2.getPerfil().getHistoricoDeCaronas().get(0)
				.getId()
				+ "";

		Assert.assertEquals(user1.getCarona(idCarona1),
				rep1.getCarona(idCarona1));
		Assert.assertEquals(user1.getCarona(idCarona2),
				rep1.getCarona(idCarona2));
		Assert.assertEquals(user1.getCarona(idCarona3),
				rep1.getCarona(idCarona3));
		Assert.assertEquals(user1.getCarona(idCarona4),
				rep1.getCarona(idCarona4));
		Assert.assertNotSame(null, rep1.getCarona(idCarona3));
		Assert.assertEquals(user2.getCarona(idCarona6).getCarona(), rep1
				.getCarona(idCarona5).getCarona());
	...
	public void TestaAdicioUser() throws Exception {
		...
		user6 = new Usuario("fulano1", "1", "FULANO",
				"Campina Grande - centro", "fulano@gmail.com");
		user7 = new Usuario("beltrano2", "12", "BELTRANO",
				"Campina Grande - bodocongó", "beltrano@gmail.com");
		user8 = new Usuario("sicrano3", "123", "CICRANO",
				"Campina Grande - bodocongó", "sicrano@gmail.com");
		user9 = new Usuario("ariolano4", "1234", "ARIOLANO",
				"Campina Grande - fofex", "ariolano@gmail.com");
		user10 = new Usuario("tiririca5", "12345", "TIRIRICA",
				"Campina Grande - centro", "tiririca@gmail.com");
	...
	public void TestaGetSetRepostorio() throws Exception {
		...
		user10 = new Usuario("tiririca5", "12345", "TIRIRICA",
				"Campina Grande - centro", "tiririca@gmail.com");
		user11 = new Usuario("Criolo", "12345", "Criolinho",
				"Campina Grande - centro", "criolo@gmail.com");
		user12 = new Usuario("xpto", "12345", "XPTO",
				"Campina Grande - centro", "xpto@gmail.com");
	...
	public void TestacheckDuplicatedData() throws Exception {
		...
		user6 = new Usuario("fulano1", "1", "FULANO",
				"Campina Grande - centro", "lucas@gmail.com");
		user7 = new Usuario("jey", "12", "BELTRANO",
				"Campina Grande - bodocongó", "beltrano@gmail.com");
		user8 = new Usuario("jojo", "123", "CICRANO",
				"Campina Grande - bodocongó", "jordao@gmail.com");
